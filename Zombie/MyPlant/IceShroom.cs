...
namespace ZombiesVsPlants.MyPlant
{
    ...
    {
        public IceShroom(Street s, Floor f)
            : base(s, f)
        {
            Hp = 2147483647;
            Dir = Direction.RIGHT;
        ...
        {
            //更新图片
            Bullet bullet = new SnowPeashooterBullet(this.Street, this.Floor, this.Dir);
            Map.addBullet(bullet);
        }
        public void Attack1()
        {
            //更新图片
            Bullet bullet = new SnowPeashooterBullet(this.Street, this.Floor, Direction.UP);
            Map.addBullet(bullet);
        }
        public void Attack2()
        {
            //更新图片
            Bullet bullet = new SnowPeashooterBullet(this.Street, this.Floor, Direction.LEFT);
            Map.addBullet(bullet);
        }
        public void Attack3()
        {
            //更新图片
            Bullet bullet = new SnowPeashooterBullet(this.Street, this.Floor, Direction.DOWN);
            Map.addBullet(bullet);
        }
    }
}