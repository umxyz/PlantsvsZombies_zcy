...
namespace ZombiesVsPlants.MyMission
{
    class Mission0 : Mission
    {
        ...
        {
            ZombiesVsPlants.PlansTime.SunFlower = ZombiesVsPlants.PlansTime.SunShroom = ZombiesVsPlants.PlansTime.TwinSunflower = 80;
        }
        ...
        {
            //初始化背景图片
            Map.BackgroundImage = Resources.NormalBackground0();
        }
        ...
        public override void CreateZombies()
        {
            ...
            while (Controller.gameStatus != GameStatus.OVER && validNum == Controller.GameTime)
            {
                if (Controller.gameStatus == GameStatus.START)
                {
                    ...
                    if (ZombiesVsPlants.AttackTime.sleeptime > 500) ZombiesVsPlants.AttackTime.sleeptime -= 100; //else ZombiesVsPlants.AttackTime.sleeptime = 100;

                    if (ZombiesVsPlants.AttackTime.sleeptime < 14700)
                    {
