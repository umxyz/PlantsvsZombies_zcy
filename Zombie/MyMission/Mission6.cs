...
namespace ZombiesVsPlants.MyMission
{
    class Mission6 : Mission
    {
        ...
        public override void initMission(Map map)
        {
            ...
            ZombiesVsPlants.PlansTime.SunFlower = ZombiesVsPlants.PlansTime.SunShroom = ZombiesVsPlants.PlansTime.TwinSunflower = 240;
            //初始化剩余界面信息
            LevelStart();
        }
        ...
        {
            //初始化背景图片
            Map.BackgroundImage = Resources.NormalBackground6();
        }
        ...
        {
            Map.initCard(new PlantCard("FlowerPot"));
            ...
            Map.initCard(new PlantCard("TallNut"));
            Map.initCard(new PlantCard("Plantern"));
        ...
        public override void CreateZombies()
        {
            ...
            while (Controller.gameStatus != GameStatus.OVER && validNum == Controller.GameTime)
            {
                if (Controller.gameStatus == GameStatus.START)
                {
                    ...
                    if (ZombiesVsPlants.AttackTime.sleeptime < 1000)
                    {
